...
RSpec.describe "dg_leagues/new", :type => :view do
  before(:each) do
    assign(:dg_league, DgLeague.new(
      :address1 => "MyString",
      :address2 => "MyString",
      :city => "MyString",
      :state => "MyString",
  ...
  it "renders new dg_league form" do
    render

    assert_select "form[action=?][method=?]", dg_leagues_path, "post" do
